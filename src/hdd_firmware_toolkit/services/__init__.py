...
from hdd_firmware_toolkit.exploit.hotpatch import HotPatchConfig, PatchTemplates, deploy_hot_patch
...
from hdd_firmware_toolkit.firmware.wd import LZHUFDecoder, WDFirmwareParser
